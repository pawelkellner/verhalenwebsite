                ...
                <div className={styles.story__content}>
                    ...
                    <div className={styles.story__information}>
                        ...
                        <div className={styles.story__spotifyPlayer}>
                            <span>
                                <Image src={"https://picsum.photos/220"} alt={'album cover'} fill></Image>
                                <span></span>
                                <PlayButtonSvg/>
                            </span>
                        </div>
